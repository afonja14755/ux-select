...
var i, b, k, x, O, g, A, E, z, m, G, y, D, S, B, _, H, L, P, v, j, w, I, C, N;
class W {
  constructor(e, t) {
    d(this, b);
    d(this, x);
    ...
    }, this.options = [], this.groups = [], T(this, i, void 0), n(this, b, k).call(this);
  }
  disable() {
...
i = new WeakMap(), b = new WeakSet(), k = function() {
  n(this, x, O).call(this), n(this, y, D).call(this), n(this, C, N).call(this);
  ...
  if (l(this, i)) {
    ...
    e.length === 1 ? (t.textContent = e[0], l(this, i).classList.add("-filled")) : e.length > 0 && this.state.multiple ? (t.textContent = `${this.localization.selectedText} ${e.length}`, l(this, i).classList.add("-filled")) : (t.textContent = this.localization.placeholder, l(this, i).classList.remove("-filled"));
  }
  ...
  s.type = "button", s.classList.add("ux-select__clear"), s.title = this.localization.clearText, e.append(t, s);
  ...
  if (l(this, i)) {
    l(this, i).addEventListener("click", n(this, S, B).bind(this));
    ...
    if (e && e.addEventListener("click", n(this, L, P).bind(this)), window.addEventListener("click", n(this, _, H).bind(this)), this.config.isSearchable) {
      ...
      t && t.addEventListener("input", n(this, w, I).bind(this));
    }
  }
};
export {
