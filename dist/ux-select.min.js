...
var f = (a, e, t) => (R(a, typeof e != "symbol" ? e + "" : e, t), t), q = (a, e, t) => {
  if (!e.has(a))
    throw TypeError("Cannot " + t);
};
var l = (a, e, t) => (q(a, e, "read from private field"), t ? t.call(a) : e.get(a)), d = (a, e, t) => {
  if (e.has(a))
    throw TypeError("Cannot add the same private member more than once");
  e instanceof WeakSet ? e.add(a) : e.set(a, t);
}, T = (a, e, t, s) => (q(a, e, "write to private field"), s ? s.call(a, t) : e.set(a, t), t);
var r = (a, e, t) => (q(a, e, "access private method"), t);
function k(a) {
...
var i, b, $, x, O, g, A, E, D, m, G, _, B, L, H, S, P, y, j, v, I, w, N, C, V;
class z {
  constructor(e, t) {
    d(this, b);
    d(this, x);
    ...
    }, this.options = [], this.groups = [], T(this, i, void 0), r(this, b, $).call(this);
  }
  disable() {
  ...
  update(e = !0) {
    r(this, x, O).call(this), r(this, m, G).call(this), this.el.disabled ? this.disable() : this.enable(), e && k(this.el);
  }
  clear() {
    ...
    }), r(this, g, A).call(this), k(this.el);
  }
  destroy() {
...
i = new WeakMap(), b = new WeakSet(), $ = function() {
  r(this, x, O).call(this), r(this, _, B).call(this), r(this, C, V).call(this);
  ...
  new Promise((e) => {
    ...
    this.options.forEach((s) => {
      ...
      if (c.classList.add("ux-select-group__elem"), c.dataset.value = s.data.value, c.textContent = s.data.text, s.attributes.selected && (c.classList.add("-selected"), t.push(s.data.text !== null ? s.data.text : "")), s.attributes.disabled && c.classList.add("-disabled"), c.addEventListener("click", r(this, v, I).bind(this)), l(this, i)) {
        const n = l(this, i).querySelector(
          `[data-ux-group="${s.attributes.group}"] .ux-select-group__list`
        );
        n && n.appendChild(c);
      }
    }), r(this, g, A).call(this, t), this.config.isGroupOptions ? e(!0) : e(!1);
  }).then((e) => {
    if (e && l(this, i)) {
      ...
      t.length > 0 && t.forEach((s) => {
        ...
        if (c) {
          const n = c.querySelectorAll(".ux-select-group__elem"), o = c.querySelectorAll(".ux-select-group__elem.-disabled");
          n.length === o.length ? s.classList.add("-disabled") : s.classList.remove("-disabled");
        }
      });
    }
  });
  ...
  if (l(this, i)) {
    ...
    e.innerHTML = "", this.groups.forEach((t) => {
      ...
      if (s.classList.add("ux-select__group", "ux-select-group"), t === "empty" && s.classList.add("-empty"), s.dataset.uxGroup = t, t !== "empty") {
        ...
        n.classList.add("ux-select-group__title"), n.textContent = t, s.appendChild(n);
      }
  ...
  if (c.classList.add("ux-select__body"), this.config.isSearchable) {
    ...
    p.type = "search", p.classList.add("ux-select-search__input"), p.placeholder = this.text.searchText, u.appendChild(p), c.appendChild(u);
  }
  const n = document.createElement("div");
  n.classList.add("ux-select__dropdown"), c.appendChild(n);
  const o = document.createElement("div"), h = ["ux-select", this.el.classList];
  this.state.multiple && h.push("-multiple"), this.state.disabled && h.push("-disabled"), o.className = h.join(" "), o.append(e, c), this.el.insertAdjacentElement("afterend", o), this.el.nextElementSibling && T(this, i, this.el.nextElementSibling), r(this, m, G).call(this);
  ...
  if (e.target !== l(this, i).querySelector(".ux-select__clear") && !s.contains(t)) {
    if (l(this, i).classList.contains("-shown"))
      ...
      const c = l(this, i).querySelector(".ux-select-search__input");
      if (!c)
  ...
  if (e.target !== null && l(this, i)) {
    ...
    if (s === "")
      l(this, i).querySelectorAll(".ux-select-group__elem").forEach((o) => o.style.display = ""), this.config.isGroupOptions && c.forEach((o) => o.style.display = "");
    else {
      ...
      new Promise((o) => {
        this.options.forEach((h) => {
          if (!l(this, i))
            throw Error("uxEl is null");
          const u = n.test(h.data.text.toLowerCase()), p = l(this, i).querySelector(`[data-value="${h.data.value}"]`);
          if (!p)
        ...
        o && c.forEach((h) => {
          ...
          u && (h.style.display = u.clientHeight !== 0 ? "" : "none");
        });
      });
    }
    U(this.el);
  ...
  if (l(this, i)) {
    l(this, i).addEventListener("click", r(this, L, H).bind(this));
    const e = l(this, i).querySelector(".ux-select__clear");
    if (e && e.addEventListener("click", r(this, y, j).bind(this)), window.addEventListener("click", r(this, S, P).bind(this)), this.config.isSearchable) {
      const t = l(this, i).querySelector(".ux-select-search__input");
      t && t.addEventListener("input", r(this, w, N).bind(this));
    }
  }
};
export {
